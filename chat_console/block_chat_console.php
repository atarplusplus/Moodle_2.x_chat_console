...
class block_chat_console extends block_base
{
    function init()
    {
        $this->title = get_string('pluginname','block_chat_console');
    }
    ...
    function get_content()
    {
        ...
        $PAGE->requires->js('/blocks/chat_console/Console.js.php');
        ...
        $PAGE->requires->js('/blocks/chat_console/content.js.php');
